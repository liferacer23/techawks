    ...
    <>
      ...
      <hr  />
        ...
        <div className="h-full w-full flex flex-col space-y-2">
          ...
          <div className="flex justify-between md:justify-center items-center p-2 ">
         ...
         <Image
                  ...
                  src={`/assets/Icons/${products?"up-arrow.svg":"drop.png"}`}
                  width={15}
                  alt="dropicon"
                  height={16} />
             ...
             <motion.div animate={{y:0,opacity:1}} initial={{y:-200,opacity:0}} exit={{y:-200,opacity:0}} transition={{duration:1}} className="absolute top-9 -left-5 bg-white border-2 border-gray-200 rounded-xl w-[150px] h-[250px] w-25 flex mb-4">
            ...
            <div className="w-[170px] h-8 md:w-80 md:w-4/12 flex items-center justify-center rounded-b-2xl rounded-t-2xl border-2 border-gray-200">
              <div className=" flex w-2/12 justify-center items-center rounded-tl-2xl">
                <Image
                  className="cursor-pointer"
              ...
              <input
                ...
                placeholder="Search.."
                className=" outline-0 w-10/12 rounded-tr-3xl rounded-br-3xl"
                type="text" />
            </div>
          </div>
