...
export default function Checkout({ setCheckout,setCartFlipper }) {
  ...
  return (
    ...
    <div className="flex flex-col absolute bg-white inset-0 ">
      <div className="mx-5">
        ...
        <div className="w-full h-fit flex flex-col p-2 space-y-2">
          <div className="flex space-x-36 mx-10 justify-between">
            ...
            <div className="flex flex-col space-y-2 p-2 h-fit pb-5 shadow-xl shadow-3xl justify-center rounded-xl w-4/6">
            <CheckoutItem/>
         <CheckoutItem/>
         <div className="flex flex-col space-y-1 ">
         <div className="flex justify-between p-2 mx-12 ">
           <h1 className="font-xs font-bold text-xxs bold text-gray-400">SUBTOTAL</h1>  
           <h1 className="font-xs font-bold text-xs font-bold">$14,477.00</h1>  
         </div>
         <div className="flex justify-between p-2 mb-5 mx-12">
           <h1 className="font-xs text-xxs font-bold text-gray-400">SHIPPING</h1>  
           <h1 className="font-xs text-xs font-bold">$50</h1>  
         </div>
         <hr className='mt-5 mx-12' />
         <div className="flex justify-between p-2 mx-12 mb-8">
           <h1 className="font-xs text-xxs font-bold text-gray-400">TOTAL</h1>  
           <h1 className="font-xs text-xs font-bold">USD $14,477.00</h1>  
         </div>
         </div>
          ...
          <div className="flex justify-between items-center h-fit p-2  w-2/6">
            ...
            <div className="flex items-center">
              <button onClick={()=>{setOrderSummary(prev=>!prev)}} className="border-2 border-black-500 rounded-full text-white text-xs bg-black h-9 w-48">
                COMPLETE PAYMENT
              </button>
            </div>
          </div>
    ...
    {orderSummary?<OrderSummary setCartFlipper={setCartFlipper} setCheckout={setCheckout} setOrderSummary={setOrderSummary}/>:""}</>
